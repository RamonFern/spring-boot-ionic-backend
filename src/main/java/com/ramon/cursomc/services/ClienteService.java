...
public class ClienteService {
	...
	public URI uploadProfilePicture(MultipartFile multipartFile) {
		...
		BufferedImage jpgImage = imageServive.getJpgImageFromFile(multipartFile);
		jpgImage = imageServive.cropSquare(jpgImage);
		jpgImage = imageServive.resize(jpgImage, size);
		
		String fileName = prefix + user.getId() + ".jpg";
			
		return s3Service.uploadFile(imageServive.getInputStream(jpgImage, "jpg"), fileName, "image");
	}
